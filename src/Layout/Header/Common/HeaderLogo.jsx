...
import BrandImage from '../../../../public/assets/images/brand-logo.png';
...
{/*  header logo */}
      ...
      <Link href='/' className={`web-logo ${extraClass? extraClass :""}`}>
        {logo?.original_url ? (
      <Image src={BrandImage} height={28} width={160} alt={`${settingData?.general?.site_name}`} />
